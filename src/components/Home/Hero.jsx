        ...
        <div className="my-auto md:my-44 mx-2 md:mx-20 space-y-4 md:space-y-8">
          ...
          <div className='md:w-1/3'>
            <h1 className='text-lg md:text-xl font-light text-white'>
              Discover our three exclusive travel packages: Holiday Trips, Outbound Adventures, and Study Immersion Programs. 🌍✈️ Experience unforgettable journeys tailored for exploration, excitement, and learning!
            </h1>
          </div>
